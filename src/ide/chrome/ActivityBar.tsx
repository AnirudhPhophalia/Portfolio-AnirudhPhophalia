...
import { Bot, FileText, Files, GitBranch, Search, Settings } from 'lucide-react'
...
export function ActivityBar() {
  ...
  const items = [
    ...
    },
    {
      key: 'copilot',
      Icon: Bot,
      label: "Anirudh's AI Assistant",
      active: state.overlay === 'copilot',
      run: () => dispatch({ type: 'OVERLAY', overlay: 'copilot' }),
    },
  ]
