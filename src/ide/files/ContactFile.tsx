...
import { ChevronRight, Globe2, Mail } from 'lucide-react'
...
const CONTACTS = [
  ...
  {
    label: 'LINKEDIN',
    value: 'linkedin.com/in/anirudh-phophalia',
    href: links.linkedin,
    Icon: LinkedinMark,
    tone: 'text-c-blue',
  },
  {
    label: 'GITHUB',
    value: 'github.com/AnirudhPhophalia',
    href: links.github,
    Icon: GithubMark,
    tone: 'text-fg',
  },
  {
    label: 'KAGGLE',
    value: 'kaggle.com/anirudhphophalia',
    href: links.kaggle,
    Icon: Globe2,
    tone: 'text-c-blue',
  },
