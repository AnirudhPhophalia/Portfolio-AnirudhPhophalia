...
const BADGES = [
  ...
  { label: 'Computer Vision', color: '#5c3ee8' },
    ...
    <>
      ...
      <ul className="mt-4 space-y-2">
        {[
          ...
          '🧠 Computer vision, deep learning, OCR, and transformer models',
          '⚙️ Full-stack applications with reliable APIs and data workflows',
          '📦 Machine learning research and applied data science',
        ].map((line) => (
